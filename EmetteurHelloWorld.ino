...
void loop() {
  ...
  if (digitalRead(2)){etatBouton=!etatBouton;
  delay(100);}

  if (etatBouton){messageCommande[0] = 'A';}
  else {messageCommande[0]= 'B';}
  
  radio.write(&messageCommande, sizeof(messageCommande));
